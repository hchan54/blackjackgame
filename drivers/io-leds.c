...
void leds_init(void)
{
    ...
    rslt = cyhal_gpio_init(PIN_RGB_RED, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_STRONG, 0);
    rslt = cyhal_gpio_init(PIN_RGB_GRN, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_STRONG, 0);
    rslt = cyhal_gpio_init(PIN_RGB_BLU, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_STRONG, 0);
}
/*****************************************************************************/
/* ICE 03 END */
/*****************************************************************************/
